...
public class PaymentMethodController {
        ...
        @Operation(summary = "Set Default Payment Method", description = "Mark the specified card as the default payment method. Previously defaulted card is automatically unset.")
        @SecurityRequirement(name = "bearerAuth")
        @ApiResponses(value = {
        ...
        @Operation(summary = "Update Card", description = "Update card nickname or billing address. Card number and expiry cannot be changed.")
        @SecurityRequirement(name = "bearerAuth")
        ...
        public ResponseEntity<ApiResponse<Void>> updateCard(@PathVariable Long cardId,
