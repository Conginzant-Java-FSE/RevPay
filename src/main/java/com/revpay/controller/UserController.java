...
public class UserController {
        ...
        public ResponseEntity<ApiResponse<Void>> createPersonalProfileWithBank(
                ...
                ApiResponse<Void> response = new ApiResponse<>(true,
                                "Personal profile and bank account created successfully");

                return ResponseEntity.ok(response);
        }

        @Operation(summary = "Update Personal Profile", description = "Update the logged-in user's personal profile and bank details")
        @ApiResponses(value = {
        ...
        public ResponseEntity<ApiResponse<Void>> updatePersonalProfileWithBank(
                ...
                ApiResponse<Void> response = new ApiResponse<>(true,
                                "Personal profile and bank account updated successfully");
        ...
        @ApiResponses(value = {
                        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Transaction PIN set successfully"),
                        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "PIN validation failed"),
