...
public class WalletController {
        ...
        @Operation(summary = "Add Funds to Wallet", description = "Simulates a card charge and credits the wallet. Creates a TOPUP transaction record.")
        ...
        @Operation(summary = "Get Wallet Balance", description = "Returns the current wallet balance and currency")
        @SecurityRequirement(name = "bearerAuth")
        @GetMapping("/balance")
        public ResponseEntity<ApiDataResponse<WalletBalanceResponse>> getWalletBalance() {
                ...
                ApiDataResponse<WalletBalanceResponse> response = new ApiDataResponse<>(true,
                                "Wallet balance fetched successfully", data);

                return ResponseEntity.ok(response);
        }

        @Operation(summary = "Get Linked Bank Account", description = "Fetches the primary linked bank account for withdrawals. Account number is masked.")
        @SecurityRequirement(name = "bearerAuth")
        ...
        public ResponseEntity<ApiDataResponse<BankAccountResponse>> getLinkedBankAccount() {
                ...
                ApiDataResponse<BankAccountResponse> response = new ApiDataResponse<>(
                                true,
        ...
        @Operation(summary = "Update Bank Account", description = "Update the linked bank account for withdrawals. Requires password confirmation.")
        @SecurityRequirement(name = "bearerAuth")
        @ApiResponses(value = {
